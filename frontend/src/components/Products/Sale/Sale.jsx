  ...
  useEffect(() => {
    const fetchProducts = async () => {
      ...
      try {
        ...
        const saleProducts = response.data.filter((product) => product.listings.includes("Sale"));
  ...
  return (
    <div className="mx-auto px-8" style={{ maxWidth: "90rem" }}>
      ...
      >
        ...
        >
          <source src="https://videos.pexels.com/video-files/4008532/4008532-uhd_2732_1440_25fps.mp4" type="video/mp4" />
