    ...
    <>
      <div className="mx-auto px-8" style={{ maxWidth: "90rem" }}>
        <div className="relative rounded-lg mx-auto" style={{ marginTop: "6rem", height: "22rem", marginBottom: "1.5rem", overflow: "hidden" }}>
          ...
          {/* "https://videos.pexels.com/video-files/8531225/8531225-uhd_2560_1440_25fps.mp4"  */}
          ...
          <div className="relative z-10 flex flex-col gap-8 justify-center" style={{ height: "22rem" }}>
            <h1 className="mb-4 font-extrabold text-white text-3xl text-center lg:text-6xl">Women's Fashion</h1>
          </div>
          <div className="absolute top-0 left-0 w-full h-full bg-black opacity-10" style={{ zIndex: 5 }}></div>
        </div>
