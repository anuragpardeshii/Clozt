...
export default function New() {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      ...
      try {
        ...
        const newProducts = response.data.filter((product) => product.listings.includes("New Arrivals"));
  ...
  }, [products, selectedCategory, selectedGender, sortOrder]);
  ...
  return (
    <div className="mx-auto px-8" style={{ maxWidth: "90rem" }}>
      ...
      >
        ...
        >
          <source src="https://videos.pexels.com/video-files/6612629/6612629-hd_1920_1080_25fps.mp4" type="video/mp4" />
